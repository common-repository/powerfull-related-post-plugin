...
rss.setAttribute('title',"<?php _e("Powerfull Related Posts PluginPlugin version history (RSS 2.0)",'drpp');?>");
...
<div class="wrap">
		<h2>
			<?php _e('Powerfull Related Posts PluginPlugin Options','drpp');?> <small><?php 
	...
	<form method="post">
			...
			<a href='https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=KSMA4U56YLF66&lc=US&item_name=111waystomakemoney&currency_code=USD&bn=PP%2dDonationsBF%3adonate%2epng%3aNonHostedGuest' target='_new'><img src="https://www.paypal.com/<?php echo paypal_directory(); ?>i/btn/btn_donate_SM.gif" name="submit" alt="<?php _e('Donate to Rahul for this plugin via PayPal');?>" title="<?php _e('Donate to Rahul for this plugin via PayPal','drpp');?>" style="float:right" /></a>

	<p><small><?php _e('by <a href="http://111waystomakemoney.com/">Rahul</a>','drpp');?>. <?php _e('Follow <a href="http://twitter.com/111waystomakem">Powerfull Related Posts PluginPlugin on Twitter</a>','drpp');?>.</small></p>
